...
<body>
    <div class="container">
        <h1 class="text-center">TUGAS PERTEMUAN 12</h1>

      
        <div class="card border-info mt-3">
            <div class="card-header">Form Input Mahasisiswa</div>
            <div class="card-body">
                <form method="POST" action="">
                    ...
                    <div>
                        <label>Alamat</label>
                        <textarea name="talamat" class="form-control" placeholder="Masukkan Alamat" required><?= @$valamat ?></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="tprodi">
                            ...
                            <option value="S1-MT">S1-Matematika</option>
                            <option value="S1-SI">S1-Sistem Informasi</option>
                            <option value="S1-AK">S1-Aktuaria</option>
                        </select>
